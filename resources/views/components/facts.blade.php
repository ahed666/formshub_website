...
@php
    $responses_svg='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<section class="fun-facts text-center">
    <div class="container">
        <div class=" facts">
              ...
              <x-fact_item :svg="$responses_svg" :count="$facts->createdforms_count" :title="trans('main.createdforms_count')"  />
