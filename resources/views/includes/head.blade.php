  ...
  أداة مراجعة على الويب, أداة مراجعة للمواقع الإلكترونية, أداة مراجعة لأداء الموظفين
  ...
  <meta property="og:image" content="{{ asset('assets/img/logos/logo1.png') }}">
  ...
  <meta name="twitter:image" content="{{ asset('assets/img/logos/logo1.png') }}">
  ...
  <!-- Google Fonts -->
    <link href=" {{ asset('https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i') }}" rel="stylesheet">
